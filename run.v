...
fn run_exe(exe_contents string) int
{
	...
	pe32_optional_header := PE32_OPTIONAL_HEADER
	{
		...
		image_size:                 u32(exe_contents[(x + 52)..(x + 56)].bytes().hex().parse_uint(16, 0) or { panic })
		...
		subsystem_version_major:    u16(exe_contents[(x + 68)..(x + 70)].bytes().hex().parse_uint(16, 0) or { panic })
		subsystem_version_minor:    u16(exe_contents[(x + 70)..(x + 72)].bytes().hex().parse_uint(16, 0) or { panic })
		win32_version_value:        u16(exe_contents[(x + 72)..(x + 74)].bytes().hex().parse_uint(16, 0) or { panic })
		size_of_image:              u32(exe_contents[(x + 74)..(x + 78)].bytes().hex().parse_uint(16, 0) or { panic })
		size_of_headers:            u32(exe_contents[(x + 78)..(x + 82)].bytes().hex().parse_uint(16, 0) or { panic })
		checksum:                   u32(exe_contents[(x + 82)..(x + 86)].bytes().hex().parse_uint(16, 0) or { panic })
		subsystem:                  u32(exe_contents[(x + 86)..(x + 90)].bytes().hex().parse_uint(16, 0) or { panic })
		dll_characteristics:        u16(exe_contents[(x + 90)..(x + 92)].bytes().hex().parse_uint(16, 0) or { panic })
		size_of_stack_reserve:      u32(exe_contents[(x + 92)..(x + 96)].bytes().hex().parse_uint(16, 0) or { panic })
		size_of_stack_commit:       u32(exe_contents[(x + 96)..(x + 100)].bytes().hex().parse_uint(16, 0) or { panic })
		size_of_heap_reserve:       u32(exe_contents[(x + 100)..(x + 104)].bytes().hex().parse_uint(16, 0) or { panic })
		size_of_heap_commit:        u32(exe_contents[(x + 104)..(x + 108)].bytes().hex().parse_uint(16, 0) or { panic })
		loader_flags:               u32(exe_contents[(x + 108)..(x + 112)].bytes().hex().parse_uint(16, 0) or { panic })
		rvas_and_sizes_number:      u32(exe_contents[(x + 112)..(x + 116)].bytes().hex().parse_uint(16, 0) or { panic })
		export_table:               u32(exe_contents[(x + 116)..(x + 120)].bytes().hex().parse_uint(16, 0) or { panic })
		import_table:               u32(exe_contents[(x + 120)..(x + 124)].bytes().hex().parse_uint(16, 0) or { panic })
		resource_table:             u32(exe_contents[(x + 124)..(x + 128)].bytes().hex().parse_uint(16, 0) or { panic })
		exception_table:            u32(exe_contents[(x + 128)..(x + 132)].bytes().hex().parse_uint(16, 0) or { panic })
		certificate_table:          u32(exe_contents[(x + 132)..(x + 136)].bytes().hex().parse_uint(16, 0) or { panic })
		base_relocation_table:      u32(exe_contents[(x + 136)..(x + 140)].bytes().hex().parse_uint(16, 0) or { panic })
		debug_table:                u32(exe_contents[(x + 140)..(x + 144)].bytes().hex().parse_uint(16, 0) or { panic })
		architecture_specific_data: u32(exe_contents[(x + 144)..(x + 148)].bytes().hex().parse_uint(16, 0) or { panic })
		rva_of_global_pointer:      u32(exe_contents[(x + 148)..(x + 152)].bytes().hex().parse_uint(16, 0) or { panic })
		tls_table:                  u32(exe_contents[(x + 152)..(x + 156)].bytes().hex().parse_uint(16, 0) or { panic })
		load_config_table:          u32(exe_contents[(x + 156)..(x + 160)].bytes().hex().parse_uint(16, 0) or { panic })
		bound_import_table:         u32(exe_contents[(x + 160)..(x + 164)].bytes().hex().parse_uint(16, 0) or { panic })
		import_address_table:       u32(exe_contents[(x + 164)..(x + 168)].bytes().hex().parse_uint(16, 0) or { panic })
		delay_import_descriptor:    u32(exe_contents[(x + 168)..(x + 172)].bytes().hex().parse_uint(16, 0) or { panic })
